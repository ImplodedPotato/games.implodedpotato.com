...
// include: /var/folders/_h/03ch86gd62d153l0b7jqxf6h0000gn/T/tmpmbklc012.js
...
Module['FS_createPath']("/assets", "glsl100", true, true);
Module['FS_createPath']("/assets", "glsl330", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/.DS_Store", "start": 0, "end": 6148}, {"filename": "/assets/glsl100/pulser.fs", "start": 6148, "end": 6981}, {"filename": "/assets/glsl100/pulser.vs", "start": 6981, "end": 7545}, {"filename": "/assets/glsl100/spotlight.fs", "start": 7545, "end": 8237}, {"filename": "/assets/glsl100/spotlight.vs", "start": 8237, "end": 8801}, {"filename": "/assets/glsl330/pulser.fs", "start": 8801, "end": 9844}, {"filename": "/assets/glsl330/pulser.vs", "start": 9844, "end": 10372}, {"filename": "/assets/glsl330/spotlight.fs", "start": 10372, "end": 11075}, {"filename": "/assets/glsl330/spotlight.vs", "start": 11075, "end": 11602}], "remote_package_size": 11602});

  })();

// end include: /var/folders/_h/03ch86gd62d153l0b7jqxf6h0000gn/T/tmpmbklc012.js
// include: /var/folders/_h/03ch86gd62d153l0b7jqxf6h0000gn/T/tmpo8_m8y6f.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/_h/03ch86gd62d153l0b7jqxf6h0000gn/T/tmpo8_m8y6f.js
// include: /var/folders/_h/03ch86gd62d153l0b7jqxf6h0000gn/T/tmpcw02osmc.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/_h/03ch86gd62d153l0b7jqxf6h0000gn/T/tmpcw02osmc.js
...
var ASM_CONSTS = {
  125832: () => { if (document.fullscreenElement) return 1; },  
 125878: () => { return document.getElementById('canvas').width; },  
 125930: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125998: () => { document.exitFullscreen(); },  
 126025: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 126098: () => { if (document.fullscreenElement) return 1; },  
 126144: () => { return document.getElementById('canvas').width; },  
 126196: () => { return screen.width; },  
 126221: () => { document.exitFullscreen(); },  
 126248: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 126381: () => { return window.innerWidth; },  
 126407: () => { return window.innerHeight; },  
 126434: () => { if (document.fullscreenElement) return 1; },  
 126480: () => { return document.getElementById('canvas').width; },  
 126532: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126600: () => { if (document.fullscreenElement) return 1; },  
 126646: () => { return document.getElementById('canvas').width; },  
 126698: () => { return screen.width; },  
 126723: () => { return window.innerWidth; },  
 126749: () => { return window.innerHeight; },  
 126776: () => { if (document.fullscreenElement) return 1; },  
 126822: () => { return document.getElementById('canvas').width; },  
 126874: () => { return screen.width; },  
 126899: () => { document.exitFullscreen(); },  
 126926: () => { if (document.fullscreenElement) return 1; },  
 126972: () => { return document.getElementById('canvas').width; },  
 127024: () => { return parseInt(document.getElementById('canvas').style.width); },  
 127092: () => { document.exitFullscreen(); },  
 127119: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 127177: () => { return screen.width; },  
 127202: () => { return screen.height; },  
 127228: () => { return window.screenX; },  
 127255: () => { return window.screenY; },  
 127282: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 127335: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 127406: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 127463: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 127719: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 127790: () => { if (document.fullscreenElement) return 1; },  
 127836: () => { return window.innerWidth; },  
 127862: () => { return window.innerHeight; },  
 127889: () => { if (document.pointerLockElement) return 1; }
};
